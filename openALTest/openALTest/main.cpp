...
int main()
{
	...
	//wavFile wav3 = openWavFile("test2.wav");
	//wavFile wav4 = openWavFile("test.wav");
	...
	//alBufferData(buffer, format, (ALvoid*)wav.songBuf, (ALsizei)wav.dataSize, (ALsizei)wav.sampleRate);
	//checkError();
	...
	//alBufferData(buffer2, format, (ALvoid*)wav2.songBuf, (ALsizei)wav2.dataSize, (ALsizei)wav2.sampleRate);
	//checkError();
